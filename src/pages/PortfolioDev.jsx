...
import WebDevelopmentHeader from "../assets/images/headers/web-development-header.png"
        ...
        <main className="card grid-container grid-x align-center portfolio">
            ...
            <section className="card-section portfolio">
                ...
                <section className="heading">
                    ...
                    <img className="develop-header" src={WebDevelopmentHeader} alt="Web Development" loading="lazy" />
